...
/**
 * Simple representation of OpenCV Mat in Java. More specifically, this is
 * the representation of a descriptor which is a 2D Mat of float
 * 
 * @author hoangtung
 * 
 */
public class Mat implements Serializable {
	 ...
	 * @param data
	 */
	public Mat(int rows, int cols, int type, float []data) {
		this.rows = rows;
		this.cols = cols;
		this.type = type;
		this.data = data;
